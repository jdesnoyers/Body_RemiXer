//Based on DepthSourceView.cs from  Microsoft Kinect Unity SDK 1.7
...
//add if DepthSourceView.cs removed from project
...
public class KinectDepthTracking : MonoBehaviour
{
